<template>
  import Scroller from './Scroller.vue'; import Scroller from './Scroller.vue';
  <Scroller>
      ...
      <div class="w-full lg:w-8/12 bg-gray-800 py-6 px-6 rounded-3xl">
        ...
        <div class="flex flex-wrap">
          <div class="w-full md:w-4/12">
            <div class="p-2">
              <div class="p-4 rounded-3xl" :style="{ backgroundColor: '#fee4cb' }">
            ...
            >
              ...
              <div class="pl-4 w-full">
                ...
                <p class="my-2 text-sm text-gray-400">
                  I got your first assignment. It was quite good. 🥳 We can continue with
                  the next assignment.
                </p>
